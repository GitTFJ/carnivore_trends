...
source("code/Background/quan_wg_a_v1.7.R")
source("code/Background/man_wg_a_v1.7.R")

full_wg_a = readRDS("Data/Analysis/full_wg_a.rds")
quan_wg_a = readRDS("Data/Analysis/quan_wg_a.rds")
man_wg_a = readRDS("Data/Analysis/man_wg_a.rds")
...
df = round(df,3)
write.csv(df, "Results/level_fit.csv")
...
ggsave("Results/level_fit.png", width = 12, height = 7)
