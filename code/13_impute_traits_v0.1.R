Traits = read.delim("Data/Traits/Traits.txt")
colnames(Traits)[1:5] = c("Order",
                          "Family",
                          "Genus",
                          "Species",
                          "Binomial")
Traits2 = read.delim("Data/Traits/Traits2.txt") 
...
anage = read.delim("Data/Traits/anage_data.txt") 
...
library(foreign)
mgs = read.dbf("Data/Traits/DatabaseMG/Updated database 2014_v1/quantitativedatatable_corrected.dbf")
mgs_spec = read.dbf("Data/Traits/DatabaseMG/Updated database 2014_v1/speciestable.dbf")
mgs = left_join(mgs, mgs_spec[,1:4])
rm(mgs_spec)

mgs_diet = read.dbf("Data/Traits/DatabaseMG/Updated database 2014_v1/diettable_corrected.dbf")
mgs_spec = read.dbf("Data/Traits/DatabaseMG/Updated database 2014_v1/speciestable.dbf")
...
CombCli = readRDS("Data/Traits/climate_gen.rds")[,c(1,6,7,8)]
...
TraitList = list()
for(n in 1:3){
Tree = read.nexus("Data/Phylogeny/Nyakatura_&_Bininda-Edmonds_2012_CarnivoraSupertree.nex")
Tree = Tree[[n]]
...
CombHab = readRDS("Data/Traits/Habitat.rds")
...
saveRDS(TraitList, "Data/Traits/TraitsFormatted.rds")
