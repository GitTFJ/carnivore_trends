...
country = read.csv("Data/CountryData/CountryContinent.csv")
...
saveRDS(regs_dic, "Data/countryIntercept.rds")


#world = read_sf("Data/UN_subregion/TM_WORLD_BORDERS-0.3.shp")
...
#plot(world_rst)
#saveRDS(world_rst, "Data/UN_subregion/country_rast.rds")
