species_int = readRDS("Data/Phylogeny/SpeciesIntercept.rds")[,c(2,3)]
colnames(species_int) = c("Species_intercept", "Species")
genus_int = readRDS("Data/Phylogeny/GenusIntercept.rds")[,c(2,3)]
colnames(genus_int) = c("Genus_intercept", "Genus")
region_int = readRDS("Data/regionIntercept.rds") [,c(4,1)]
colnames(region_int) = c("Region_intercept", "Conts")
country_int = readRDS("Data/countryIntercept.rds")[,c(4,6)]
...
jpeg("Results/scen_plot.jpeg", width = 5, height = 8, units = "in", res = 300)
