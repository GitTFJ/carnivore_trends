TraitList = readRDS("Data/Traits/TraitsFormatted.rds")
...
GGally::ggpairs(Traits[,c(9,8,5,16,14)],
                ...
                axisLabels="none") + 
  theme_classic() 
ggsave("Results/Trait_cor.png", width = 8, height = 8)
