...
source("code/Background/full_unw_v1.7.R")
source("code/Background/full_nobs_v1.7.R")
source("code/Background/full_wg_a_v1.7.R")

full_unw = readRDS("Data/Analysis/full_unw.rds")
full_nobs = readRDS("Data/Analysis/full_nobs.rds")
full_wg_a = readRDS("Data/Analysis/full_wg_a.rds")
...
df = round(df,3)
write.csv(df, "Results/weight_fit.csv")
...
ggsave("Results/weight_fit.png", width = 12, height = 7)
