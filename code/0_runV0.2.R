...
#Trend ----
#source(file = "code/15_prepare_trend_v0.4.R")
rm(list=setdiff(ls(), c("Trends", "Coords")))

#Add covariates ----
#source(file = "code/16_add_covariates_v0.3.R")
rm(list=setdiff(ls(), c("")))
Trends = readRDS("Data/Analysis/DataToModel3.rds")

#Select model ----
#source("code/17_simulate_trend_error_v0.2.R")
...
source("code/24_scrutinise_model_v0.5.R")
source("code/25_prepare_region_intercept_v0.2.R")
source("code/26_prepare_country_intercept_v0.2.R")
...
source("code/30_explore_hdi_v0.4.R")
source("code/31_assess_bias_v0.1.R")
source("code/32_explore_hdi_accuracy_v0.1.R")
source("code/33_nonlinear_hdi_v0.1.R")
